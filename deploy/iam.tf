...
resource "aws_iam_role_policy" "spot_lambda_policy" {
  name = "SpotLambdaPolicy"
  role = aws_iam_role.spot_lambda_role.id
  ...
  policy = jsonencode({
    ...
    Statement = [
      ...
      },
      {
        ...
        Resource = [
          aws_dynamodb_table.spots.arn,
          aws_dynamodb_table.comments.arn,
          aws_dynamodb_table.spot_likes.arn,
          aws_dynamodb_table.spot_reactions.arn,
...
resource "aws_iam_role" "auth_lambda_role" {
  name = "shitplace-auth-lambda-role"
...
resource "aws_iam_role" "chatbot_lambda_role" {
  name = "ShitPlace-ChatBot-Lambda-Role"
...
resource "aws_iam_role" "image_lambda_role" {
  name = "shitplace-image-lambda-role"
    ...
    Statement = [
      ...
      },
      {
        ...
        Resource = [
          ...
          aws_dynamodb_table.shitplace_image_metadata.arn
        ]
      },
      {
        Effect = "Allow"
